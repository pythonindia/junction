    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=255, verbose_name="Choice Feedback Title"
                    ),
                ),
                ("conference", models.ForeignKey(to="conferences.Conference")),
                (
                    "schedule_item_type",
                    models.ForeignKey(to="schedule.ScheduleItemType"),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=255, verbose_name="Choice Feedback Value Title"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "device",
                    models.ForeignKey(blank=True, to="devices.Device", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=255, verbose_name="Text Feedback Title"
                    ),
                ),
                ("conference", models.ForeignKey(to="conferences.Conference")),
                (
