    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "author",
                    models.ForeignKey(
                        verbose_name="Primary Speaker", to=settings.AUTH_USER_MODEL
                    ),
                ),
                ("conference", models.ForeignKey(to="conferences.Conference")),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name="Proposal Section", to="proposals.ProposalSection"
            ),
        ...
        migrations.AddField(
            ...
            name="proposal_type",
            field=models.ForeignKey(
                verbose_name="Proposal Type", to="proposals.ProposalType"
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
